    ...
    const handleDelete = async (quoteIdToDelete) => {
        ...
        try {
            const res = await fetch(
                `${apiBaseUrl}/api/quotes/${quoteIdToDelete}`,
                {
                    method: "DELETE",
                    headers: {
                        "Content-Type": "application/json",
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full overflow-hidden transform transition-all">
                        <div className="p-6 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">
                                Delete Quote #{deleteConfirmation.quoteId}?
                            </h3>
                            ...
                            <div className="flex gap-3 justify-center">
                                ...
                                <button
                                    onClick={() =>
                                        handleDelete(deleteConfirmation.quoteId)
                                    }
