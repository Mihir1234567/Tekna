...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex bg-white">
            {/* --- Right Side: Image --- */}
            <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900 order-last">
                ...
                <div className="relative z-10 flex flex-col justify-center px-12 text-white">
                    ...
                    <p className="text-xl text-gray-200 max-w-md leading-relaxed">
                        Create your account to start generating precise window
                        quotes and managing your orders instantly.
                    </p>
                </div>
            </div>
